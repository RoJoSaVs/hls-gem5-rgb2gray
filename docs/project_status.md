...
Este documento resume el estado de los entregables principales del proyecto
RGB a escala de grises con SystemC/TLM, HLS, Vivado y Vitis.

## Completado

| Entregable | Estado | Evidencia |
|---|---|---|
| Modelo SystemC/TLM base | Completado | `src/` |
| Conversor RGB a grayscale en SystemC | Completado | `src/accelerator.h` |
...
| Imagen de salida final | Completado | `build/output.raw` y `build/output.png`, generados con el modelo SystemC/TLM |
| Documentacion HLS en README | Completado | `README.md` |
