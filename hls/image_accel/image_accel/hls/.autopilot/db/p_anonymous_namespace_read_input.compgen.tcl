...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_input_rgb \
    op interface \
    ports { input_rgb { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rgb_stream_din { O 24 vector } rgb_stream_num_data_valid { I 7 vector } rgb_stream_fifo_cap { I 7 vector } rgb_stream_full_n { I 1 bit } rgb_stream_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_num_pixels_c1 \
    op interface \
    ports { num_pixels_c1_din { O 32 vector } num_pixels_c1_num_data_valid { I 3 vector } num_pixels_c1_fifo_cap { I 3 vector } num_pixels_c1_full_n { I 1 bit } num_pixels_c1_write { O 1 bit } } \
} "
}
