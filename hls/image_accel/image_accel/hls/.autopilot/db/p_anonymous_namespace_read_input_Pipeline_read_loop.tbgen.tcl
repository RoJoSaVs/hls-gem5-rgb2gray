set moduleName p_anonymous_namespace_read_input_Pipeline_read_loop
set isTopModule 0
...
set C_modelName {(anonymous namespace)read_input_Pipeline_read_loop}
...
set portList { 
	...
	{ m_axi_gmem0_RFIFONUM sc_in sc_lv 13 signal 2 } 
	...
	{ rgb_stream_din sc_out sc_lv 24 signal 3 } 
	{ rgb_stream_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ rgb_stream_fifo_cap sc_in sc_lv 7 signal 3 } 
	{ rgb_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ rgb_stream_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "14", "Max" : "6220811"}
	, {"Name" : "Interval", "Min" : "14", "Max" : "6220811"}
]}
