...
entity image_accel_fifo_w8_d64_S is 
    generic (
...
architecture rtl of image_accel_fifo_w8_d64_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component image_accel_fifo_w8_d64_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 6;
        DEPTH      : integer := 64);
...
begin
----------------------- Instantiation -----------------------
    U_image_accel_fifo_w8_d64_S_ShiftReg : image_accel_fifo_w8_d64_S_ShiftReg
    generic map (
...
entity image_accel_fifo_w8_d64_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 6;
        DEPTH      : integer := 64);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end image_accel_fifo_w8_d64_S_ShiftReg;

architecture rtl of image_accel_fifo_w8_d64_S_ShiftReg is
