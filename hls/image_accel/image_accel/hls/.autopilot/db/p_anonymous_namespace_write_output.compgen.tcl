...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_output_gray \
    op interface \
    ports { output_gray_dout { I 64 vector } output_gray_num_data_valid { I 3 vector } output_gray_fifo_cap { I 3 vector } output_gray_empty_n { I 1 bit } output_gray_read { O 1 bit } } \
} "
}
