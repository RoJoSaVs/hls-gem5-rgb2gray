set moduleName p_anonymous_namespace_write_output_Pipeline_write_loop
set isTopModule 0
...
set C_modelName {(anonymous namespace)write_output_Pipeline_write_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ num_pixels_1 int 32 regular  }
	{ gray_stream int 8 regular {fifo 0 volatile }  }
	{ output_gray_1 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "num_pixels_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_gray_1", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ gray_stream_dout sc_in sc_lv 8 signal 1 } 
	{ gray_stream_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ gray_stream_fifo_cap sc_in sc_lv 7 signal 1 } 
	{ gray_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ gray_stream_read sc_out sc_logic 1 signal 1 } 
	...
	{ output_gray_1 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_gray_1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_gray_1", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	output_gray_1 { ap_none {  { output_gray_1 in_data 0 64 } } }
