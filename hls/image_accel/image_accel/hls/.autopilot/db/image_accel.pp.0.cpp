...
# 2 "<built-in>" 2
# 1 "../src/image_accel.cpp" 2
# 1 "../src/image_accel.hpp" 1


# 1 "../src/image_accel_types.hpp" 1


# 1 "/tools/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/ap_int.h" 1
# 10 "/tools/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/ap_int.h"
...
# 11 "/tools/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/ap_int.h" 2
...
# 10 "/tools/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/ap_fixed.h"
...
# 361 "/tools/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/ap_int.h" 2
# 4 "../src/image_accel_types.hpp" 2
...
# 39 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstdint" 2 3
...
# 5 "../src/image_accel_types.hpp" 2
# 18 "../src/image_accel_types.hpp"
static constexpr uint32_t kImageAccelWidth = 1920;
static constexpr uint32_t kImageAccelHeight = 1080;
static constexpr uint32_t kImageAccelMaxPixels = 2073600;
static constexpr uint32_t kImageAccelInputBytesPerPixel =
    3;
static constexpr uint32_t kImageAccelMaxRgbBytes = 6220800;
...
# 4 "../src/image_accel.hpp" 2
# 16 "../src/image_accel.hpp"
extern "C" __attribute__((sdx_kernel("image_accel", 0))) void image_accel(
    volatile const image_accel_byte_t* input_rgb,
    volatile image_accel_byte_t* output_gray,
    image_accel_pixel_count_t num_pixels);
# 2 "../src/image_accel.cpp" 2
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=2073600 avg=2073600
...
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=image_accel
# 84 "../src/image_accel.cpp"




#pragma HLS INTERFACE m_axi port=input_rgb offset=slave bundle=gmem0 depth=6220800 max_read_burst_length=64 num_read_outstanding=16
#pragma HLS INTERFACE m_axi port=output_gray offset=slave bundle=gmem1 depth=2073600 max_write_burst_length=64 num_write_outstanding=16
