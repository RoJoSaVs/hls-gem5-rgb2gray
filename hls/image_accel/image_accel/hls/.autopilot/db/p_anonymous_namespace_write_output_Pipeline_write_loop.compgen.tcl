...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_num_pixels_1 \
    op interface \
    ports { num_pixels_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { gray_stream_dout { I 8 vector } gray_stream_num_data_valid { I 7 vector } gray_stream_fifo_cap { I 7 vector } gray_stream_empty_n { I 1 bit } gray_stream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_output_gray_1 \
    op interface \
    ports { output_gray_1 { I 64 vector } } \
} "
}
