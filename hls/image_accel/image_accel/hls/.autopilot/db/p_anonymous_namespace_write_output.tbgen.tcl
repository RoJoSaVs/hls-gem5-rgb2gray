set moduleName p_anonymous_namespace_write_output
set isTopModule 0
...
set C_modelName {(anonymous namespace)write_output}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 1}  }
	{ output_gray int 64 regular {fifo 0}  }
	{ gray_stream int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_gray","offset": { "type": "dynamic","port_name": "output_gray","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "output_gray", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gray_stream", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_gray_dout sc_in sc_lv 64 signal 1 } 
	{ output_gray_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ output_gray_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ output_gray_empty_n sc_in sc_logic 1 signal 1 } 
	{ output_gray_read sc_out sc_logic 1 signal 1 } 
	{ gray_stream_dout sc_in sc_lv 8 signal 2 } 
	{ gray_stream_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ gray_stream_fifo_cap sc_in sc_lv 7 signal 2 } 
	{ gray_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ gray_stream_read sc_out sc_logic 1 signal 2 } 
	{ num_pixels_dout sc_in sc_lv 32 signal 3 } 
	{ num_pixels_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ num_pixels_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ num_pixels_empty_n sc_in sc_logic 1 signal 3 } 
	{ num_pixels_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_gray_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_gray", "role": "dout" }} , 
 	{ "name": "output_gray_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_gray", "role": "num_data_valid" }} , 
 	{ "name": "output_gray_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_gray", "role": "fifo_cap" }} , 
 	{ "name": "output_gray_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_gray", "role": "empty_n" }} , 
 	{ "name": "output_gray_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_gray", "role": "read" }} , 
 	{ "name": "gray_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gray_stream", "role": "dout" }} , 
 	...
 	{ "name": "gray_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gray_stream", "role": "empty_n" }} , 
 	{ "name": "gray_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gray_stream", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_write_output_Pipeline_write_loop_fu_58", "Port" : "gmem1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "output_gray", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_gray_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "gray_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_write_output_Pipeline_write_loop_fu_58", "Port" : "gray_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_write_output_Pipeline_write_loop_fu_58", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_write_output_Pipeline_write_loop_fu_58.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11", "Max" : "2073610"}
	, {"Name" : "Interval", "Min" : "11", "Max" : "2073610"}
]}
...
set Spec2ImplPortList { 
	...
	output_gray { ap_fifo {  { output_gray_dout fifo_data_in 0 64 }  { output_gray_num_data_valid fifo_status_num_data_valid 0 3 }  { output_gray_fifo_cap fifo_update 0 3 }  { output_gray_empty_n fifo_status 0 1 }  { output_gray_read fifo_port_we 1 1 } } }
	gray_stream { ap_fifo {  { gray_stream_dout fifo_data_in 0 8 }  { gray_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { gray_stream_fifo_cap fifo_update 0 7 }  { gray_stream_empty_n fifo_status 0 1 }  { gray_stream_read fifo_port_we 1 1 } } }
