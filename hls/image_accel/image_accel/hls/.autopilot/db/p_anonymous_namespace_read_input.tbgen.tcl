set moduleName p_anonymous_namespace_read_input
set isTopModule 0
...
set C_modelName {(anonymous namespace)read_input}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 8 regular {axi_master 0}  }
	{ input_rgb int 64 regular  }
	{ rgb_stream int 24 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_rgb","offset": { "type": "dynamic","port_name": "input_rgb","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "input_rgb", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "rgb_stream", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ input_rgb sc_in sc_lv 64 signal 1 } 
	{ rgb_stream_din sc_out sc_lv 24 signal 2 } 
	{ rgb_stream_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ rgb_stream_fifo_cap sc_in sc_lv 7 signal 2 } 
	{ rgb_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ rgb_stream_write sc_out sc_logic 1 signal 2 } 
	{ num_pixels sc_in sc_lv 32 signal 3 } 
	{ num_pixels_c1_din sc_out sc_lv 32 signal 4 } 
	{ num_pixels_c1_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ num_pixels_c1_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ num_pixels_c1_full_n sc_in sc_logic 1 signal 4 } 
	{ num_pixels_c1_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_rgb", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_rgb", "role": "default" }} , 
 	{ "name": "rgb_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rgb_stream", "role": "din" }} , 
 	...
 	{ "name": "rgb_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgb_stream", "role": "full_n" }} , 
 	{ "name": "rgb_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgb_stream", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_read_input_Pipeline_read_loop_fu_70", "Port" : "gmem0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "input_rgb", "Type" : "None", "Direction" : "I"},
			{"Name" : "rgb_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_read_input_Pipeline_read_loop_fu_70", "Port" : "rgb_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_read_input_Pipeline_read_loop_fu_70", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_read_input_Pipeline_read_loop_fu_70.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16", "Max" : "6220813"}
	, {"Name" : "Interval", "Min" : "16", "Max" : "6220813"}
]}
...
set Spec2ImplPortList { 
	...
	input_rgb { ap_none {  { input_rgb in_data 0 64 } } }
	rgb_stream { ap_fifo {  { rgb_stream_din fifo_data_in 1 24 }  { rgb_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { rgb_stream_fifo_cap fifo_update 0 7 }  { rgb_stream_full_n fifo_status 0 1 }  { rgb_stream_write fifo_port_we 1 1 } } }
