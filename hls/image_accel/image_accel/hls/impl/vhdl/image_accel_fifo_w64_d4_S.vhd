...
entity image_accel_fifo_w64_d4_S is 
    generic (
...
architecture rtl of image_accel_fifo_w64_d4_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component image_accel_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_image_accel_fifo_w64_d4_S_ShiftReg : image_accel_fifo_w64_d4_S_ShiftReg
    generic map (
...
entity image_accel_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end image_accel_fifo_w64_d4_S_ShiftReg;

architecture rtl of image_accel_fifo_w64_d4_S_ShiftReg is
