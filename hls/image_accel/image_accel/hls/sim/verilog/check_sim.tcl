...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.image_accel.autotvin_gmem0.dat"
         "c.image_accel.autotvin_input_rgb.dat"
         "c.image_accel.autotvin_output_gray.dat"
         "c.image_accel.autotvin_num_pixels.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.image_accel.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
