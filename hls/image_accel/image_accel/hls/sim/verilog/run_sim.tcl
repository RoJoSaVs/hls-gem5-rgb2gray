...
if {[file isfile image_accel.autotvin.dat]} {
	file delete -force image_accel.autotvin.dat
}

if {[file isfile image_accel.autotvout.dat]} {
	file delete -force image_accel.autotvout.dat
}
