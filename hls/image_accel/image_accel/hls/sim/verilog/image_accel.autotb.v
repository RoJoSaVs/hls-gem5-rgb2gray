...
`define AUTOTB_DUT      image_accel
`define AUTOTB_DUT_INST AESL_inst_image_accel
`define AUTOTB_TOP      apatb_image_accel_top
`define AUTOTB_LAT_RESULT_FILE "image_accel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "image_accel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_image_accel_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 2.00

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_input_rgb 1
`define AESL_DEPTH_output_gray 1
`define AESL_DEPTH_num_pixels 1
`define AUTOTB_TVIN_gmem0  "../tv/cdatafile/c.image_accel.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_rgb  "../tv/cdatafile/c.image_accel.autotvin_input_rgb.dat"
`define AUTOTB_TVIN_output_gray  "../tv/cdatafile/c.image_accel.autotvin_output_gray.dat"
`define AUTOTB_TVIN_num_pixels  "../tv/cdatafile/c.image_accel.autotvin_num_pixels.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.image_accel.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_rgb_out_wrapc  "../tv/rtldatafile/rtl.image_accel.autotvin_input_rgb.dat"
`define AUTOTB_TVIN_output_gray_out_wrapc  "../tv/rtldatafile/rtl.image_accel.autotvin_output_gray.dat"
`define AUTOTB_TVIN_num_pixels_out_wrapc  "../tv/rtldatafile/rtl.image_accel.autotvin_num_pixels.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.image_accel.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.image_accel.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 6220813;
parameter LENGTH_gmem0 = 6220800;
parameter LENGTH_gmem1 = 2073600;
parameter LENGTH_input_rgb = 1;
parameter LENGTH_num_pixels = 1;
parameter LENGTH_output_gray = 1;
...
reg end_input_rgb;
reg [31:0] size_input_rgb;
reg [31:0] size_input_rgb_backup;
reg end_output_gray;
reg [31:0] size_output_gray;
reg [31:0] size_output_gray_backup;
reg end_num_pixels;
reg [31:0] size_num_pixels;
reg [31:0] size_num_pixels_backup;
reg end_gmem1;
reg [31:0] size_gmem1;
...
reg dump_tvout_finish_gmem1;

initial begin : dump_tvout_runtime_sign_gmem1
    integer fp;
    dump_tvout_finish_gmem1 = 0;
    fp = $fopen(`AUTOTB_TVOUT_gmem1_out_wrapc, "wb");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gmem1_out_wrapc);
    ...
    fp = $fopen(`AUTOTB_TVOUT_gmem1_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gmem1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
