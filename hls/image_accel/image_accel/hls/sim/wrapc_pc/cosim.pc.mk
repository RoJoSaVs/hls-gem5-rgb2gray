...
AUTOPILOT_ROOT := /tools/Xilinx/Vitis_HLS/2024.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /tools/Xilinx/Vitis_HLS/2024.1/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/image_accel_tb.cpp_pre.cpp.tb.o : image_accel_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling image_accel_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/image_accel.cpp_pre.cpp.tb.o : image_accel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling image_accel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
