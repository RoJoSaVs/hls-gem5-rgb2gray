...
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2024.1/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "image_accel.autotvin.dat"
	set constFileTvOut       "image_accel.autotvout.dat"
	set constFileHdlTvIn     "image_accel.autohdltvin.dat"
	set constFileHdlTvOut    "image_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
